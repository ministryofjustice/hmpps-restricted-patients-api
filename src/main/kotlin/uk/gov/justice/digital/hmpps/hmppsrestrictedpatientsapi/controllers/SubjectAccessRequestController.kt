...
import uk.gov.justice.digital.hmpps.hmppsrestrictedpatientsapi.config.ErrorResponse
...
class SubjectAccessRequestController(private val service: SubjectAccessRequestService) {
  ...
  fun getSarContentByReference(
    ...
    if (!prn.isNullOrBlank()) {
      return service.getContentFor(prn, fromDate, toDate)
