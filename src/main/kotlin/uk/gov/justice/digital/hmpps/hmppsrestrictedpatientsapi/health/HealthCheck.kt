...
@Component
class PrisonApiHealthCheck(@Qualifier("prisonApiHealthWebClient") webClient: WebClient) : HealthCheck(webClient)

@Component
class PrisonerSearchApiHealthCheck(@Qualifier("prisonerSearchHealthWebClient") webClient: WebClient) : HealthCheck(webClient)
