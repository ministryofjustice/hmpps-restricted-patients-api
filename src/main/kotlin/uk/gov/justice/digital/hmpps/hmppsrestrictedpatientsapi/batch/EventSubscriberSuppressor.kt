...
import uk.gov.justice.digital.hmpps.hmppsrestrictedpatientsapi.services.EventSubscriber
...
class EventSubscriberSuppressor : BeanFactoryPostProcessor {

  override fun postProcessBeanFactory(beanFactory: ConfigurableListableBeanFactory) {
    (beanFactory as DefaultListableBeanFactory).beanDefinitionNames
      .filter { name -> beanFactory.isBeanAssignableFrom<EventSubscriber>(name) }
