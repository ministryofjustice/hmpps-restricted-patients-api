...
class OpenApiDocsTest : IntegrationTestBase() {
  ...
  fun `the generated open api for date times hasn't got the time zone`() {
    webTestClient.get()
      ...
      .expectStatus().isOk
      .expectBody()
      .jsonPath("$.components.schemas.RestrictedPatientDto.properties.dischargeTime.example").isEqualTo("2021-07-16T12:34:56")
      .jsonPath("$.components.schemas.RestrictedPatientDto.properties.dischargeTime.type").isEqualTo("string")
      .jsonPath("$.components.schemas.RestrictedPatientDto.properties.dischargeTime.format").isEqualTo("date-time")
      .jsonPath("$.components.schemas.RestrictedPatientDto.properties.dischargeTime.description").isEqualTo("Date and time the prisoner was discharged to hospital")
      .jsonPath("$.components.schemas.RestrictedPatientDto.properties.dischargeTime.pattern").doesNotExist()
  }
